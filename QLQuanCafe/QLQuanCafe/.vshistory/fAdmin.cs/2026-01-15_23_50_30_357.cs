...
namespace QLQuanCafe
{
    public partial class fAdmin : Form
    {
        ...
        private void dtgvFoodDrink_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex < 0) return;
            ...
            cbFoodCategory.SelectedValue =
                Convert.ToInt32(row.Cells["IDCategory"].Value);

...
namespace QLQuanCafe
{
    public partial class fAdmin : Form
    {
        ...
        private void dtpkDateCheckIn_ValueChanged(object sender, EventArgs e)
        {

        }

        private void dtpkDateCheckOut_ValueChanged(object sender, EventArgs e)
        {
        ...
        ORDER BY b.dateCheckOut";
            ...
            reportViewer1.LocalReport.ReportEmbeddedResource = "QLQuanCafe.rpDoanhThu.rdlc";

            //rpvDoanhThu.LocalReport.ReportPath = "rpDoanhThu.rdlc";

            ReportDataSource rds = new ReportDataSource("dtDoanhThu", dt);
